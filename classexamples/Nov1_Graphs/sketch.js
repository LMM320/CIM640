...
function barChart(data,base,bWidth, space) {
  ...
  for (var i = 0; i < data.length; i++) {
    ...
    //bWidth is the width of the column 10x3)
    //space - space in between graph
    //yPos is the base which is always 300
    //bWidth minus "10"-space=space
    //Date map it 0 to max Data biggest number + 10 
